...
export const articles: Article[] = [
...

  {
    ...
    content: [
      ...
      {
        type: "paragraph",
        text: "The deeper work involves understanding what drives persistent stress responses and addressing it at a psychological level. This is typically what counselling offers; somatic approaches in particular can work with the body not just as a coping tool, but as a route into understanding and processing what has accumulated over time.",
      },
    ],
  },

  {
    ...
    excerpt:
      "If you have ever sat in a meeting feeling certain that everyone else truly belongs while you are somehow getting away with it, you are not alone. Understanding what imposter syndrome is (and is not) is a useful first step.",
    date: "2026-08-12",
...

  {
    ...
    content: [
      {
        type: "paragraph",
        text: "Boundary-setting has become one of the most discussed topics in emotional health, and also one of the most misunderstood. For many people, the idea of setting a limit conjures images of confrontation, selfishness, or letting people down. No wonder so few people actually do it.",
      },
      {
        type: "heading",
