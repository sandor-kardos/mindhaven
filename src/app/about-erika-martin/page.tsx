...
export default function AboutErikaMartin() {
  return (
    <div className="flex flex-col w-full bg-[#FEFFF7] text-[#0D2E24]">
      ...
      <section className="py-16 lg:py-24 px-4 bg-gradient-to-b from-[#FEFFF7] to-[#FEFFF7] border-b border-[#34D399]/15">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="relative w-full max-w-lg">
                <div className="absolute -inset-4 bg-gradient-to-tr from-[#34D399]/20 via-[#FEFFF7] to-[#34D399]/10 rounded-[2.5rem] blur-2xl opacity-80 animate-aura-drift" />
                ...
                {/* Name overlay floating in front of blob */}
                <div className="absolute -bottom-4 left-4 right-4 bg-[#0D2E24] rounded-2xl shadow-xl p-5 z-10 border border-[#34D399]/20 text-center">
                  ...
                  <p className="text-[11px] text-slate-300 font-medium mt-1">PSA Registered</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                <div className="p-4 bg-white rounded-2xl border border-[#34D399]/20 shadow-xs flex items-start gap-3">
      ...
      <section className="py-20 px-4 bg-white border-b border-[#34D399]/10">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <div className="p-6 bg-[#FEFFF7] rounded-2xl border border-[#34D399]/15 card-flow-effect space-y-3">
              <div className="w-10 h-10 rounded-xl bg-[#FEFFF7] flex items-center justify-center">
      ...
      <section className="py-20 px-4 bg-[#FEFFF7]/50 border-b border-[#34D399]/10">
        <div className="container mx-auto max-w-4xl">
          <div className="bg-white rounded-3xl border border-[#34D399]/20 shadow-md p-8 md:p-12 space-y-8 card-flow-effect">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-2xl bg-[#FEFFF7] flex items-center justify-center shrink-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#FEFFF7] hover:bg-[#34D399] text-[#0D2E24] hover:text-white border border-[#34D399]/30 rounded-full text-xs font-bold transition-colors group"
              >
              ...
              <Link
                href="/contact#book"
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#0D2E24] hover:bg-[#34D399] text-white border border-transparent rounded-full text-xs font-bold transition-colors"
              >
                <span>Book a Free Introductory Call</span>
