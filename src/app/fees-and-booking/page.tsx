        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch max-w-4xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-3xl border border-[#34D399]/20 shadow-md card-flow-effect flex flex-col justify-between h-full">
              ...
              <Link href="/contact" className="w-full text-center py-3.5 px-4 bg-[#FEFFF7] text-[#0D2E24] font-bold text-sm rounded-full border border-[#34D399]/30 hover:bg-[#34D399] hover:text-white transition-colors">Get in Touch</Link>
            </div>
            ...
            <div className="bg-[#0D2E24] text-white p-8 rounded-3xl border-2 border-[#34D399] shadow-2xl card-flow-effect flex flex-col justify-between h-full relative overflow-hidden">
              ...
              <Link href="/contact" className="w-full text-center py-3.5 px-4 bg-[#34D399] hover:bg-white hover:text-[#0D2E24] text-white font-bold text-sm rounded-full transition-colors shadow-md relative z-10">Enquire About Package</Link>
            </div>
