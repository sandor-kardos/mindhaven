      ...
      <section className="pt-20 pb-16 px-4 bg-gradient-to-b from-[#FEFFF7] to-[#FEFFF7] text-[#0D2E24] text-center border-b border-[#34D399]/20">
        <div className="container mx-auto max-w-3xl space-y-4">
          ...
          <p className="text-lg text-[#0D2E24]/85 font-medium leading-relaxed max-w-2xl mx-auto">
            Straightforward pricing for individual sessions and a structured six-session programme. No surprises.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-white border-t border-[#34D399]/15 text-center">
        <div className="container mx-auto max-w-2xl space-y-6">
          ...
          <p className="text-[#0D2E24]/80 font-medium leading-relaxed">
            A free 15-minute introductory call is available to talk through what you are looking for and whether working together feels right. There is no obligation to proceed.
          </p>
          <Link
            href="/contact#book"
