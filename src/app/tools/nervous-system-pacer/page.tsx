    ...
    <div className="flex flex-col w-full bg-white text-[#0D2E24] min-h-screen">
      ...
      <section className="py-12 sm:py-16 px-4 bg-white">
        <div className="container mx-auto max-w-3xl space-y-10">
          ...
          {/* Simple Plain Description & Step-by-Step Instructions (Now Above the App) */}
          <div className="bg-white p-6 sm:p-8 rounded-3xl border border-[#34D399]/30 shadow-md space-y-6">
            <h3 className="text-lg sm:text-xl font-bold text-[#0D2E24] font-heading flex items-center gap-2">
              <Clock className="w-5 h-5 text-[#34D399]" />
              <span>How to use the 4-7-8 exercise</span>
            </h3>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 pt-1">
              <div className="p-4 rounded-2xl bg-slate-50 border border-[#34D399]/20 space-y-1.5">
                <span className="text-lg font-extrabold text-[#059669] font-heading">01. Breathe In</span>
              ...
              <div className="p-4 rounded-2xl bg-slate-50 border border-[#34D399]/20 space-y-1.5">
                <span className="text-lg font-extrabold text-[#059669] font-heading">02. Hold</span>
                <p className="text-xs text-[#0D2E24]/85 font-medium leading-relaxed">
              ...
              <div className="p-4 rounded-2xl bg-slate-50 border border-[#34D399]/20 space-y-1.5">
                <span className="text-lg font-extrabold text-[#059669] font-heading">03. Breathe Out</span>
                <p className="text-xs text-[#0D2E24]/85 font-medium leading-relaxed">
          ...
          <div className="bg-white rounded-3xl border-2 border-[#34D399]/40 shadow-2xl p-6 sm:p-10 text-center max-w-xl mx-auto space-y-6">
            <div className="space-y-1.5">
              <span className="text-xs font-extrabold text-[#059669] uppercase tracking-wider font-heading">
                Guided Rhythm
              </span>
              <h2 className="text-xl sm:text-2xl font-bold text-[#0D2E24] font-heading">
